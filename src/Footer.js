...
function Footer() {
	const infos = {
		address: "Aouatif I N: 408 , El Kelaa des Sraghna MOROCCO",
		phone: "+212 624979777",
		email: "atahiri@student.1337.ma"
	}
	return (
		<>
		<section className="bg-white border-b py-8">
		<div className="container max-w-5xl mx-auto m-8">
		<h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800" id="contactme">
		Contact Me
		</h1>
            ...
            <div className="mt-8 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form className="p-6 flex flex-col justify-center">
                        ...
                        <button type="submit" className="md:w-32 bg-yellow-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-yellow-500 transition ease-in-out duration-300">
                            Submit
                        </button>
                    </form>
                </div>
