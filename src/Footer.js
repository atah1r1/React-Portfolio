            ...
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form class="p-6 flex flex-col justify-center">
                        ...
                        <button type="submit" class="md:w-32 bg-yellow-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-yellow-500 transition ease-in-out duration-300">
                            Submit
                        </button>
                    </form>
                </div>
