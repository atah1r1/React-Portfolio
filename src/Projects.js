...
function ProjectCard({name, description, img, languages, github}) {
  ...
  <div className="bg-gray-300 h-2/6 w-full rounded-lg shadow-md bg-cover bg-center"><img alt="images" className="h-w_full w-full justify-center" src={img}></img></div>
            ...
            <div className=" w-70 bg-white -mt-10 shadow-lg rounded-lg overflow-hidden p-5">
              ...
              <div className="header-content inline-flex">
                ...
                <div className="category-title flex-3 text-sm"> {languages}</div>
              </div>
              <div className="title-post font-bold">{name}</div>
